...
struct Counter
{
   ...
   public:
    ...
    Counter();
    Counter(uint32_t *p_currentValuePtr, const std::vector<State> p_states, const bool p_loop = true,
            const bool p_active = true);
    Counter(const std::vector<State> p_states, const bool p_loop = true, const bool p_active = true);
    Counter(const int32_t p_initialValue, const int32_t p_finalValue, const int32_t m_deltaValue,
            const double m_interval, const bool p_loop = true, const bool p_active = true);
    ...
    void Set(const int32_t p_initialValue, const int32_t p_finalValue, const int32_t p_deltaValue,
